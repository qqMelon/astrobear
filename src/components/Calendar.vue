...
// Événements par défaut si aucun n'est fourni via les props
const defaultEvents = [
  {
    id: 1,
...
// Utiliser les événements fournis via props ou les événements par défaut
const raidEvents = computed(() => {
        ...
        <template #day-popover="{ attributes }">
          <div class="custom-popover">
            <div 
              ...
              :key="attr.key" 
              class="popover-event"
              @click="handleEventEdit(attr.customData)"
              :class="{ 'editable': props.isEditable }"
            >
              ...
              <div v-if="props.isEditable" class="popover-edit-hint">
...
.popover-event.editable {
  cursor: pointer;
  transition: all 0.2s ease;
}

.popover-event.editable:hover {
  background: rgba(249, 131, 58, 0.1);
  transform: translateX(2px);
}
